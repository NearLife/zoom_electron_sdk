...
void ZoomNodeMeetingParticipantsCtrlWrap::GetUserInfoByUserID(const v8::FunctionCallbackInfo<v8::Value>& args)
{
    ...
    node->Set(context, v8::String::NewFromUtf8(isolate, "isTalking",v8::NewStringType::kInternalized).ToLocalChecked(), v8::Boolean::New(isolate, zn_userInfomation.isTalking));
#if (defined _WIN32)
