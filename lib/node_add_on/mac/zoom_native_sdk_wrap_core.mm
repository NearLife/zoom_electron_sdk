...
ZNSDKError ZNativeSDKWrap::SetSupportDarkModel(bool isDark)
{
    if(ZoomSDKError_Success == [[ZoomSDK sharedSDK] setSupportDarkModel:isDark]){
       return ZNSDKERR_SUCCESS;
    }else{
       return ZNSDKERR_SETTING_OS_DONT_SUPPORT;
    }  
}
