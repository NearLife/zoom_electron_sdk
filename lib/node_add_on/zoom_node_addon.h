...
public:
	...
	static void SetSupportDarkModel(const v8::FunctionCallbackInfo<v8::Value>& args);
...
static void InitClassAttribute<ZoomNodeWrap >(const v8::Local<v8::FunctionTemplate>& tpl, v8::Isolate* isolate)
{
	...
	NODE_SET_PROTOTYPE_METHOD(tpl, "SetSupportDarkModel", ZoomNodeWrap::SetSupportDarkModel);
}
template<>
